...
mod wordnet_v3;
use wordnet_v3::{init_wordnet, search_wordnet, get_first_definitions, add_word_entry, add_sense_to_word, delete_word_entry, delete_sense_from_word};
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![search_wordnet, get_first_definitions, add_word_entry, add_sense_to_word, delete_word_entry, delete_sense_from_word])
